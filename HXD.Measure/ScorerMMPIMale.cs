...
{
    public class ScorerMMPIMale : Scorer
    {
        private Hashtable hsSpecialScoreRef = new Hashtable();
        public ScorerMMPIMale()
        {
            ...
            this.hsSpecialScoreRef.Add("mf_f179", new int[]
			{
				default(int),
				1
			});
            Hashtable arg_2AA_0 = this.hsSpecialScoreRef;
            object arg_2AA_1 = "si180";
            int[] array12 = new int[2];
            array12[0] = 1;
            arg_2AA_0.Add(arg_2AA_1, array12);
            ...
            Hashtable arg_307_0 = this.hsSpecialScoreRef;
            object arg_307_1 = "si201";
            int[] array13 = new int[2];
            array13[0] = 1;
            arg_307_0.Add(arg_307_1, array13);
            ...
            array16[0] = 1;
            arg_3FF_0.Add(arg_3FF_1, array16);
            this.hsSpecialScoreRef.Add("hy292", new int[]
			{
				default(int),
				1
			});
            this.hsSpecialScoreRef.Add("mf_f297", new int[]
			{
				default(int),
				1
			});
            Hashtable arg_45C_0 = this.hsSpecialScoreRef;
            object arg_45C_1 = "si316";
            int[] array17 = new int[2];
            array17[0] = 1;
            arg_45C_0.Add(arg_45C_1, array17);
            ...
            object arg_49A_1 = "si370";
            int[] array18 = new int[2];
            array18[0] = 1;
            arg_49A_0.Add(arg_49A_1, array18);
            Hashtable arg_4B9_0 = this.hsSpecialScoreRef;
            object arg_4B9_1 = "si373";
            int[] array19 = new int[2];
            array19[0] = 1;
            arg_4B9_0.Add(arg_4B9_1, array19);
        }
