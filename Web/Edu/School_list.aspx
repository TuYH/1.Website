<%@ Page Language="C#" AutoEventWireup="true" CodeFile="School_list.aspx.cs" Inherits="Edu_School_list" %>
<%@ Register src="ascx/left.ascx" tagname="left" tagprefix="uc1" %>
<%@ Register src="ascx/top.ascx" tagname="top" tagprefix="uc3" %>
<!doctype html>
<html>
...
<form id="myform" runat="server">
    ...
    <uc1:left ID="left1" runat="server" RoomID="5"/>
                                            ...
                                            <ItemTemplate>
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-secondary am-text-sdary" href="chart_s.aspx?id=<%#Eval("id")%>"><span class="am-icon-pencil-square-o"></span> 统计</a>
