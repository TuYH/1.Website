<%@ Page Language="C#" AutoEventWireup="true" CodeFile="from_x.aspx.cs" Inherits="Edu_from_x" %>
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form id="Form1" class="am-form am-form-horizontal" runat="server" >
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">单位 / Content</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">班级 / Content</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="保存"  class="am-btn am-btn-primary"/>
                                    </div>
                                </div>
                            </form>
                        </div>
