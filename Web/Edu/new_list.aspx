<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_list.aspx.cs" Inherits="Edu_new_list" %>
                                                    ...
                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                ...
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-text-sdary" href="font_list.aspx?id=<%#Eval("id")%>&Action=del"><span class="am-icon-trash-o"></span> 删除</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
