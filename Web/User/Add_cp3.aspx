<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_cp3.aspx.cs" Inherits="User_Add_cp3" %>
    ...
    <uc1:left ID="left1" runat="server" RoomID="2"/>
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">第二步选择来访者</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 第二步选择来访者
                    </div>
                    <div class="tpl-portlet-input tpl-fz-ml">
                        <div class="portlet-input input-small input-inline">
                            <div class="input-icon right">
                                ...
                                <input id="Text1" type="text" class="am-form-field" runat="server"/>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <asp:Button ID="Button1" runat="server" class="am-btn am-btn-default am-btn-warning" Text="提交任务" onclick="Button1_Click" />
                                </div>
                            </div>
                        </div>
