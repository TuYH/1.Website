<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Charts.aspx.cs" Inherits="User_Charts" %>
...
<%--                                                                <a onClick="return confirm('确认删除')" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-text-sdary" href="font_list.aspx?id=<%#Eval("Fresultid")%>&Action=del"><span class="am-icon-trash-o"></span> 删除</a>
--%>                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
