...
public partial class user_fd_gtadd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //cid 1=消息 2=预约  3=辅导
        string sql2 = "insert into tb_U_Message (ClassId,Content,zxs_id,uid,state,yy_time,cid) values('" + sc_id + "','" + content + "','" + MenuId + "','" + xid + "','5','" + DateTime.Now.ToString() + "','3')";
