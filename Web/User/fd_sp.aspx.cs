...
public partial class User_fd_sp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            mod.Condition = " Userid=" + userid + " and classid=2";
            ...
            DataSet ds = HXD.DBUtility.SQLHelper.ExecuteDataset("select top 20 title,classid,IsStatus,posttime from tb_U_info where Userid=" + userid + " and classid=2 order by Sort desc,id desc;");
