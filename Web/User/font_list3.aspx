<%@ Page Language="C#" AutoEventWireup="true" CodeFile="font_list3.aspx.cs" Inherits="User_font_list3" %>
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 测评结果
                    </div>
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                 <tr>
                                                    ...
                                                    <td><a href="#"><%#Eval("FstudentNo")%></a></td>
                                                    <td class="am-hide-sm-only"><%#getname(Eval("FstudentNo").ToString())%></td>
                                                    <td><%#Eval("Fscore")%></td>
                                                    ...
                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-secondary am-text-sdary" href="chart_scl.aspx?rid=<%#Eval("id")%>&Action=lock"><span class="am-icon-pencil-square-o"></span>查看结果</a>
