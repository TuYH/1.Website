...
public partial class User_form_info : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string sql_u = "update tb_U_school set s_name='" + xx_name + "',note ='" + xx_note + "' where id=" + userid;
        HXD.DBUtility.SQLHelper.ExecuteScalar(sql_u);
        string sql = "insert into tb_U_school (s_name,note)valuers('" + xx_name + "','" + xx_note + "')";
