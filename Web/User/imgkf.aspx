<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imgkf.aspx.cs" Inherits="User_imgkf" %>
...
<form id="myform" runat="server">
    ...
    <uc1:left ID="left1" runat="server" RoomID="20"/>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                      <a href="imgkf_add.aspx" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>
新增</a>
                                                 ...
                                                 <tr>
                                                   ...
                                                   <td class="am-hide-sm-only"><%#Eval("posttime", "{0:yyyy-MM-dd HH:mm:ss}")%></td>
                                                    ...
                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-text-sdary" href="imgkf_add.aspx?wzid=<%#Eval("id")%>"><span class="am-icon-trash-o"></span> 查看/修改</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
