<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imgkf_add.aspx.cs" Inherits="User_imgkf_add" %>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">添加绘画治疗</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 添加绘画治疗
                    </div>
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            ...
                            <div class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">绘画</label>
                                    <div class="am-u-sm-9">
