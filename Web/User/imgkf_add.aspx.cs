...
public partial class User_imgkf_add : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "insert into tb_U_info(Title,Content,ClassId,userid)values('" + title + "','" + content + "','" + str_se + "','" + MenuId + "')";
        HXD.DBUtility.SQLHelper.ExecuteNonQuery(sql);
        StringDeal.Alter("提交成功！", "imgkf.aspx");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update tb_U_info set title='" + title + "',Content='" + content + "',ClassId='" + str_se + "' where id=" + idc;
        HXD.DBUtility.SQLHelper.ExecuteNonQuery(sql);
        StringDeal.Alter("更新成功！", "imgkf.aspx");
