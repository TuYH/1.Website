<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zx_msg.aspx.cs" Inherits="User_zx_msg" %>
...
<div class="pet_news_list_tag_name">测评通知</div>
                  ...
                  <ItemTemplate>
                   <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                      <a href="#" class="pet_hd_block">
                        <div class="pet_hd_block_title"><%#getzt(Eval("Content").ToString(),Eval("state").ToString())%></div>
                        <%--<div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i><%#HXD.Common.StringDeal.Substrings((Eval("uid").ToString()),15)%></div>--%>
                        <div class="pet_hd_block_tag"><%#getzt(Eval("state").ToString())%>&nbsp;&nbsp;<%#Eval("posttime", "{0:yyyy-MM-dd}")%>  </div>
                      </a>
                    </li>
                  </ItemTemplate>
                  </asp:Repeater>
