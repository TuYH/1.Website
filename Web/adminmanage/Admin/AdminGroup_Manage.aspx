<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminGroup_Manage.aspx.cs" Inherits="adminmanage_Admin_AdminGroup_Manage" %>
...
<div id="edit">
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      <td class="title">管理员组管理</td>
      <td align="right"  nowrap="nowrap"><span class="hui operation">管理导航 - <span class="blue">组列表</span> | <a href="AdminGroup_Edit.aspx" class="red">添加组</a></span></td>
    </tr>
  </table>
