<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="AdvertisementUpDate.aspx.cs" Inherits="adminmanage_Advertisement_AdvertisementUpDate" %>
...
<div id="edit">
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="red_xx table_all">
    <tr>
      ...
      <td align="right"  nowrap><span class="hui operation">管理导航 - 广告编辑 | <a href="AdvertisementList.aspx?Page=<%=Pages %>">广告列表</a></span></td>
    </tr>
  </table>
  ...
  <table align="center" cellspacing="1" class="table table_all" id="table1">
    ...
    <tr id="adsize" runat="server" style="display:none;" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
    ...
    <tr id="adfile" runat="server" style="display:none;" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      ...
      <td>
            ...
            <div id="filetable1" runat="server">&nbsp;<asp:TextBox ID="FileStr" CssClass="input1" runat="server"></asp:TextBox><input id="Button3" class="input1" type="button" value="浏览..." onclick="openWin();" style="width: 70px; height: 22px; font-size: 13px;"/></div>
            <div id="filetable2" runat="server" style="display:none;">&nbsp;<input id="File1" class="input1" runat="server" type="file" /></div>--%>
            &nbsp;<input id="File1" class="input1" runat="server" type="file" />
      </td>
    </tr>
    <tr id="adflash" runat="server" style="display: none" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      <td><strong>Flash文件：</strong></td>
      <td>&nbsp;<input id="File2" class="input1" runat="server" type="file" /></td>
    </tr>
    <tr id="adlink" runat="server" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      <td><strong>广告链接：</strong></td>
      <td>&nbsp;<asp:TextBox ID="TextBox4" runat="server" MaxLength="300" CssClass="input1"></asp:TextBox></td>
    </tr>
    <tr id="adlinkstr" runat="server" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      <td><strong>文字说明：</strong></td>
      <td>&nbsp;<asp:TextBox ID="TextBox5" runat="server" MaxLength="100" CssClass="input1"></asp:TextBox></td>
    </tr>
    <tr id="adjs" runat="server" style="display:none;" onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
