<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Edit.aspx.cs" Inherits="adminmanage_User_User_Edit" ValidateRequest="false" %>
...
<div id="edit">
  ...
  <table align="center" cellspacing="1" class="table table_all" id="table1">
    <tr class="td_bg">
      <td colspan="2" class="redbold"><asp:Literal ID="GroupTitle" runat="server"></asp:Literal>编辑面版</td>
    </tr>
    <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      <td width="200"><span class="left2"><strong>用户名：</strong></span></td>
      <td width="574">
          &nbsp;<asp:TextBox ID="UserName" runat="server" MaxLength="25"></asp:TextBox></td>
    </tr>
    <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
      <td><span class="left2"><strong>密码：</strong></span></td>
      <td>
          &nbsp;<asp:TextBox ID="UserPwd" runat="server" CssClass="input1 required validate-length-range-4-20 useTitle" title="密码请输入4-20位有效字符！" MaxLength="400" TextMode="Password"></asp:TextBox></td>
    </tr>
    <tr onmouseover="over()" onclick="change()" onmouseout="out()" class="td_bg">
