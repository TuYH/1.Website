<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp_list.aspx.cs" Inherits="cp_cp_list" %>
...
<head id="Head1" runat="server">
	...
	<style type="text/css">
        ...
        #header h1,#header p{background:none !important}
    </style>
...
<body id="test1" class="test1">
    <div id="content">
        ...
        <div class="text-center header">
            <h1 class="bold" style="color:#FC4A98;">★心理测试★</h1>
            <p>
