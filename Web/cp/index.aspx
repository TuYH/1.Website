<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="cp_index" %>
...
function result2(t){
    ...
    $("div#bd > div.panel-body").hide();
            ...
            $.post("../API/Get_answer.aspx?score="+t+"&iid=1", function (data) {
                //$(".result").html(data);
                $("div.js_result").eq(0).find(".resulttitle").eq(0).html(data);
            });
            $.post("../API/Get_result.aspx?para="+t+"&iid=1", function (data) {
                //$(".result").html(data);
    ...
    <script>
        $(function () {
            ...
            if (navigator.userAgent.indexOf("MicroMessenger") == -1) {
                $("#weixinfollowlink").attr("href", "http://www.hnxlzx.cn/");
                $("#weixinfollowlink1").attr("href", "http://www.hnxlzx.cn/");
                $("#weixinfollowlink2").attr("href", "http://www.hnxlzx.cn/");
                $("#weixinfollowlink3").attr("href", "http://www.hnxlzx.cn/");
            }
        });
