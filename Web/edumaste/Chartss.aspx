<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chartss.aspx.cs" Inherits="edumaste_Chartss" %>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">漩涡减压反馈系统</li>
            </ol>
    ...
    <div class="am-margin">
        <asp:Button ID="Button1" runat="server" Text="查询" 
            class="am-btn am-btn-primary am-btn-xs" onclick="Button1_Click"/>
              ...
              <asp:Button ID="Button3" runat="server" Text="导出查询数据" 
                                                    ...
                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                ...
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-secondary am-text-sdary" href="chart_scl.aspx?rid=<%#Eval("id")%>&Action=lock"><span class="am-icon-pencil-square-o"></span> 修改</a>
