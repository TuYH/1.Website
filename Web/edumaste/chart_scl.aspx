<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chart_scl.aspx.cs" Inherits="edumaste_chart" %>
             ...
             <!--startprint-->
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> <%=str_lbname %>
                    </div>
                ...
                <div class="tpl-block">
				   ...
				   <div class="tpl-blockcoseC">班级：<%=str_banji %></div>
				   <div class="tpl-blockcoseC">年级：<%=str_nianji %></div>
                   ...
                   <br />
                    <asp:Panel ID="Panel1" runat="server" Visible="False">
                     <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 分析：
                    </div>
