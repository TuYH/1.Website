...
public partial class edumaste_chart : System.Web.UI.Page
{
    protected string str_name = "",str_nianji="",str_banji="", str_jieguo = "", str_note = "", posttime = "", str_content = "", str_df = "", str_time = "", str_namelist = "", str_lbname = "", str_daan="";
    ...
    protected void stre()
    {
        ...
        str_lbname = HXD.DBUtility.SQLHelper.ExecuteScalar(lbname_sql).ToString();
    ...
    protected string getlbname2(string id)
    {
