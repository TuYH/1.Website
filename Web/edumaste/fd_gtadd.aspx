<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fd_gtadd.aspx.cs" Inherits="edumaste_fd_gtadd" %>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="fd_gt.aspx">个体辅导</a></li>
                <li class="am-active">添加个体辅导记录</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 添加个体辅导记录
                    </div>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            ...
                            <div class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">辅导内容</label>
                                    <div class="am-u-sm-9">
