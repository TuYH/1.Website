<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fd_sp.aspx.cs" Inherits="edumaste_fd_sp" %>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                      <a href="fd_spadd.aspx" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>新增</a>
                                         ...
                                         <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                 <tr>
                                                    ...
                                                    <td><%#Eval("id")%></td>
                                                    <td><%#getname(Eval("classid").ToString())%></td>
