<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fd_ttadd.aspx.cs" Inherits="edumaste_fd_ttadd" %>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="fd_tt.aspx">辅导记录</a></li>
                <li class="am-active">添加团体辅导记录</li>
            </ol>
