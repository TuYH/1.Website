...
public partial class edumaste_file : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    string sql = "select count(id) from tb_user where username='" + excl_xuehao + "' and classid='" + MenuId + "'";
                    ...
                    else
                    {
                        ...
                        //Session["userid"] = icd;
                        string sqlin3 = "insert into tb_U_User (Id,msn,name,sex,shengri,nationality,Address,ks_name,nianji,banji,tel,Mobile,jieji)values('" + icd + "','" + excl_xuehao + "','" + excl_name + "','" + excl_sex + "','" + excl_Birthday + "','" + excl_nationality + "','" + excl_address + "','" + excl_ksname + "','" + excl_nianji + "','" + excl_banji + "','" + excl_tel + "','" + excl_tel2 + "','" + excl_jieji + "')";
