<%@ Page Language="C#" AutoEventWireup="true" CodeFile="font_list.aspx.cs" Inherits="edumaste_font_list" %>
...
<form id="myform" runat="server">
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
       ...
       <uc1:left ID="left1" runat="server" RoomID="1" />
                    ...
                    <div class="am-g">
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-input-group am-input-group-sm">
                                ...
                                <input id="uname"  class="am-form-field" type="text" runat="server" placeholder="用户名"/>
                                <span class="am-input-group-btn"><asp:Button ID="Button3" runat="server" Text="搜索"  class="am-btn am-btn-default am-btn-success tpl-am-btn-success am-icon-search" onclick="Button3_Click"/></span>
                            </div>
                        </div>
                    </div>
                    <div class="am-g">
