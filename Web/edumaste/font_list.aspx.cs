...
public partial class edumaste_font_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            mod.Condition = " Classid=" + scholl_id + " and GroupId=5  ";
            ...
            DataSet ds = HXD.DBUtility.SQLHelper.ExecuteDataset("select top 20 UserName,RegTime,islock from tb_User where Classid=" + scholl_id + "  and GroupId=5 order by Sort desc,id desc;");
    ...
    protected void getztOperation()
    {
        ...
        if (icd > 0)
        {
            ...
            if (Action == "del")
            {
                string sql = "delete from tb_User where ID='" + icd + "'";
