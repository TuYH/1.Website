...
public partial class edumaste_font_list2 : System.Web.UI.Page
{
    ...
    protected string getzt(string str)
    {
        ...
        string zt_no = "<img src=\"assets/img/yes.png\">";
        string zt_yes= "<img src=\"assets/img/no.png\">";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            foreach (string i in sArray)
            {
                ...
                string sql2 = "delete from tb_User where ID='" + i + "';delete from tb_U_User where ID='" + i + "';delete from tb_U_Message where uid='" + i + "';delete from t_exam_subitems_score where Fresultid='" + i + "'";
