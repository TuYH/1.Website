...
public partial class edumaste_new_fladd : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        int sid = pdsj(str_se);
        string sql = "update tb_U_schoolfl  set title='" + title + "',ClassId='" + str_se + "',Sid='" + menid + "',Depth='" + sid + "',mb_id='" + mb_id + "' where id='"+id+"'";
        HXD.DBUtility.SQLHelper.ExecuteScalar(sql);
        Response.Redirect("new_fl.aspx");
    }
}