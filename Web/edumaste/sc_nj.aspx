<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sc_nj.aspx.cs" Inherits="edumaste_sc_nj" %>
...
<form id="myform" runat="server">
    ...
    <uc1:left ID="left1" runat="server" RoomID="13"/>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <a  class="am-btn am-btn-default am-btn-warning" href="sc_njadd.aspx">添加</a>
                                    ...
                                    <%--    <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                 <tr>
                                                    ...
                                                    <td><%#Eval("id")%></td>
                                                    <td><%#getc(Eval("depth").ToString())%><img src="assets/img/tree_plusmiddle1.png"/>&nbsp;<%#Eval("title")%></td>
                                                    <td class="am-hide-sm-only"><%#Eval("sort")%></td>
                                                   

                                                    <td>
                                                        <div class="am-btn-toolbar">
                                                            <div class="am-btn-group am-btn-group-xs">
                                                                <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-text-sdary" href="new_fl.aspx?id=<%#Eval("id")%>&Action=del"><span class="am-icon-trash-o"></span> 删除</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
