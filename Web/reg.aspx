...
<body>
<form class="am-form" runat="server" method="post" action="reg.aspx" onsubmit="return SubCheck()">
<div class="container">
	<header data-am-widget="header" class="am-header am-header-default my-header">
      ...
      <h1 class="am-header-title">
        <a href="#title-link" class="">超级管理员注册</a>
      </h1>
    ...
    <div class="cart-panel">
            ...
            <div class="am-form-group am-form-icon">
                ...
                <input id="txtAdminName" type="text" class="am-form-field  my-radius" placeholder="请输入您的用户名" onblur="checkUsername()" runat="server"/>
            ...
            <div class="am-form-group am-form-icon">
                ...
                <asp:TextBox ID="TextBox6" runat="server"  class="am-form-field  my-radius" placeholder="请输入您的昵称" onblur="checkname()"></asp:TextBox>
            </div>
            <div class="am-form-group am-form-icon">
                <i class="am-icon-envelope" style="color:#78c3ca"></i>
                
                <asp:TextBox ID="TextBox4" runat="server"  class="am-form-field  my-radius" placeholder="请输入邮箱号码"></asp:TextBox>
            </div>
            <div class="am-form-group am-form-icon">
                <i class="am-icon-phone" style="color:#f09513"></i>
                
                <asp:TextBox ID="TextBox5" runat="server"  class="am-form-field  my-radius" placeholder="请输入联系电话"></asp:TextBox>
            </div>
   ...
   <script  language="javascript" type="text/javascript">
       ...
       function checkUsername() {
           var username = document.getElementById("txtAdminName").value;
